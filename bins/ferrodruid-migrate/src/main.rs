...
enum Command {
    ...
    /// is readable by FerroDruid's v9 reader — attachable when the
    /// attach feature ships. Judgment tool only: nothing is migrated
    /// or modified. Local deep storage only (for S3/HDFS/GCS, pull the
