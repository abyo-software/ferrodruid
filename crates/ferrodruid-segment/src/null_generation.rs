...
pub fn classify_column(name: &str, column: &ColumnData) -> ColumnNullGeneration {
    let (handling, legacy_signature) = match column {
        ...
        // Complex (sketch) columns — opaque OR decoded per-row
        // theta/hyperUnique — carry no null convention this detector
        ...
        | ColumnData::ComplexHyperUnique(_) => (NullHandling::Unconfirmed, false),
    };
